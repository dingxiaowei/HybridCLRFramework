    ...
    public static class BuildAssetsCommand
    {
        ...
        private static void BuildAssetBundles(string tempDir, string outputDir, BuildTarget target)
        {
            ...
            List<AssetBundleBuild> abs = new List<AssetBundleBuild>();
            {
                ...
                var prefabAssets1 = new List<string>();
                string testPrefab1 = $"{Application.dataPath}/Prefabs/TestPrefab.prefab";
                prefabAssets1.Add(testPrefab1);
                abs.Add(new AssetBundleBuild
                {
                    assetBundleName = "prefabs1",
                    assetNames = prefabAssets1.Select(s => ToRelativeAssetPath(s)).ToArray(),
                });
            }
